    ...
    <section class="bg-ally7 p-5">
        ...
        {chats.map((props) => (
          <section class="border border-ally10 rounded-lg p-5">
            <div>
              ...
              <button class="bg-ally2 hover:bg-ally1 text-white font-bold py-2 px-4 rounded"
               onClick={async () => {
                setInputs({
                  chatID: props.id,
                  recipientID: props.id,
      ...
      {sqlSurvey.map((props)=> (
        <section key={props.id}>
         Name: {props.fullName}, Q1: {props.q1}, Q2: {props.q2}, Q3: {props.q3},  
          Q4: {props.q4}, Q5: {props.q5}, Q6: {props.q6}, Q7: {props.q7}, Q8: {props.q8}, Q9: {props.q9}
        </section>
      ))}
      </div>
            ...
            <div class="mt-5 sm:mt-6">
              <span class="flex w-full rounded-md shadow-sm">
                ...
                <button id="messagesubmit"
                  ...
                  className="p-2 border border-gray-300 bg-ally8 text-white"
                >
                  Send
                </button> <br/>
                <button
